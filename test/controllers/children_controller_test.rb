...
class ChildrenControllerTest < ActionController::TestCase
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post :create, child: { email_address: @child.email_address, family: @child.family, name: @child.name, phone_number: @child.phone_number }
    end
  ...
  test "should update child" do
    patch :update, id: @child, child: { email_address: @child.email_address, family: @child.family, name: @child.name, phone_number: @child.phone_number }
    assert_redirected_to child_path(assigns(:child))
  end
